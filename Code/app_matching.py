...
# ---------- STEP 3: HASHING ----------
def generate_hashes(constellation, fan_out=4, max_freq=4000):
    """
...
def recognize_uploaded_song(file_path="/home/vibgyor/BTP/musical/query/jeena_jeena_recording.mp3"):
    """
